...
MIDDLEWARE = [
    ...
    'botman_backend.tenant_middleware.TenantContextMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'analytics.middleware.RequestLoggingMiddleware',
]

CORS_ALLOW_ALL_ORIGINS = True  # Simplified for testing, can be restricted later
CORS_ALLOW_CREDENTIALS = True

ROOT_URLCONF = 'botman_backend.urls'
...
WSGI_APPLICATION = 'botman_backend.wsgi.application'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'botman_backend.exceptions.custom_exception_handler',
